...
class SeqDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            feature_transformer: Transformer for neighbor target-derived features
            general_feature_scaler: Scaler for general features (climate/static/calendar)
        """
        self.cfg = cfg
    ...
    def _build_features(self):
        ...
        # Neighbor target histories (raw values, no explicit lags for sequence models)
...
def create_dataloaders(
    ...
    """
    train_dataset = SeqDataset(city_df, neighbor_lags_df, cfg, fold, 'train', target_scaler, feature_transformer, general_feature_scaler)
    val_dataset = SeqDataset(city_df, neighbor_lags_df, cfg, fold, 'val', target_scaler, feature_transformer, general_feature_scaler)
